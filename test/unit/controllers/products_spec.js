...
describe('controllers: Products', () => {
        ...
        context('when an error occurs', () => {
            it('should return 422', async () => {
                ...
                sinon
                    ...
                    sinon.assert.alwaysCalledWith(response.status, 422)
            })
        })
    })
    ...
    describe('update() product', () => {
        it('should respond with 200 when the product has been updated', async() => {
            ...
            //simulated express body request
            const request = {
                params: {
                    id: fakeId
                },
            ...
            //adding expected behavior from updatedOne it should be transformed into a stub
    ...
    describe('delete() product', () => {
        it('should return 204 when a product has been deleted', async() => {
            const fakeId = 'a-fake-id'
            const request = {
                params: {
                    id: fakeId
            ...
            deleteOneStub
                .withArgs({ _id: fakeId }).resolves([1])
